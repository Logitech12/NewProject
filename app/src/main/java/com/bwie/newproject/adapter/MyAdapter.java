...
public class MyAdapter extends CardAdapter {
    Context context;
    List<ShouBean.TuijianBean.ListBean> tjlist;

    public MyAdapter(Context context, List<ShouBean.TuijianBean.ListBean> tjlist) {
    ...
    class ViewHolder {
        ...
        public void bindData(int index,List<ShouBean.TuijianBean.ListBean> tjlist) {
